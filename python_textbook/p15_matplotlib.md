...
plt.show()
~~~
<img src="./Files/plt07.png" style="zoom:100%;" />
...
plt.show()
~~~
<img src="./Files/plt14.jpeg" style="zoom:100%;" />
...
- align：条形的对齐方式（默认为 "center"，表示x值和条形中心对齐，"edge" 表示x值和条形左边对齐）
~~~python
import matplotlib.pyplot as plt
import numpy as np
...
plt.show()
~~~
<img src="./Files/plt15.png" style="zoom:100%;" />
<img src="./Files/plt16.png" style="zoom:100%;" />
